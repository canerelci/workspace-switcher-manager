...
export const Options = class Options {
    constructor(extension) {
        ...
        this.options = {
            ...
            pointerWorkspaceSelectEnabled: ['boolean', 'pointer-workspace-select-enabled'],
            pointerWorkspaceSelectHotkeyPreset: ['int', 'pointer-workspace-select-hotkey-preset'],
            pointerWorkspaceSelectAccelerator: ['strv', 'pointer-workspace-select-accelerator'],
            pointerWorkspaceSelectPersistUntilClick: ['boolean', 'pointer-workspace-select-persist-until-click'],
            pointerWorkspaceSelectDebugOverlay: ['boolean', 'pointer-workspace-select-debug-overlay'],
            fontScale: ['int', 'font-scale'],
            indexScale: ['int', 'index-scale'],
            popupLabelPaddingScale: ['int', 'popup-label-padding-scale'],
            ...
            popupHeightScale: ['int', 'popup-height-scale'],
